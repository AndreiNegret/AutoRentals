...
namespace ASRental.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(Services.Interfaces.IAuthentificationService authService,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _authService.Login(Input.Email, Input.Password, Input.RememberMe);
                if (result.Succeeded)
                {
